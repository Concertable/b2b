...
namespace Concertable.B2B.E2EAdmin.UnitTests;
...
public sealed class E2EAdminSecurityTests
{
    ...
    [InlineData("")]
    [InlineData(" ")]
    public void AddB2BE2EAdmin_BlankAdminKey_ThrowsInvalidOperationException(string? adminKey)
    {
    ...
    [Fact]
    public void AddB2BE2EAdmin_NonE2EEnvironment_ThrowsInvalidOperationException()
    {
    ...
    private static IConfiguration Configuration(string? adminKey) =>
        new ConfigurationBuilder()
            .AddInMemoryCollection(new Dictionary<string, string?>
            {
                ...
                ["ConnectionStrings:B2BDb"] = "Server=test",
            })
            .Build();
