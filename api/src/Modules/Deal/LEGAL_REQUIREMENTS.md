...
direction (item 4). The concert type already encodes the VenueHire direction flip in
`SettlementPayerTenantId` / `SettlementPayeeTenantId` — the VAT calculator needs the same awareness.
