...
namespace Concertable.B2B.Concert.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260916112746_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Concertable.B2B.Concert.Domain.Entities.ConcertAccessGrant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("ResourceId", "TenantId", "Scope")
                        .IsUnique()
                        .HasDatabaseName("UX_ConcertAccessGrants_TenantWide")
                        .HasFilter("[RevokedAt] IS NULL AND [MemberUserId] IS NULL");

                    b.HasIndex("ResourceId", "TenantId", "Scope", "MemberUserId")
                        .IsUnique()
                        .HasDatabaseName("UX_ConcertAccessGrants_Member")
                        .HasFilter("[RevokedAt] IS NULL AND [MemberUserId] IS NOT NULL");

                    b.HasIndex("TenantId", "Scope", "ResourceId", "MemberUserId")
                        .HasFilter("[RevokedAt] IS NULL");

                    b.ToTable("ConcertAccessGrants", "concert");
                });
            ...
            modelBuilder.Entity("Concertable.B2B.Concert.Domain.Entities.InvoiceAccessGrant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ResourceId", "TenantId", "Scope")
                        .IsUnique()
                        .HasDatabaseName("UX_InvoiceAccessGrants_TenantWide")
                        .HasFilter("[RevokedAt] IS NULL AND [MemberUserId] IS NULL");

                    b.HasIndex("ResourceId", "TenantId", "Scope", "MemberUserId")
                        .IsUnique()
                        .HasDatabaseName("UX_InvoiceAccessGrants_Member")
                        .HasFilter("[RevokedAt] IS NULL AND [MemberUserId] IS NOT NULL");

                    b.HasIndex("TenantId", "Scope", "ResourceId", "MemberUserId")
                        .HasFilter("[RevokedAt] IS NULL");

                    b.ToTable("InvoiceAccessGrants", "concert");
                });
            ...
            modelBuilder.Entity("Concertable.B2B.Concert.Domain.Entities.InvoiceAccessGrant", b =>
                {
                    b.HasOne("Concertable.B2B.Concert.Domain.Entities.InvoiceEntity", null)
                        .WithMany("AccessGrants")
                        .HasForeignKey("ResourceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
