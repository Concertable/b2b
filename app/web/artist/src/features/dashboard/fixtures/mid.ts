  ...
  applications: [
    ...
    },
    {
      ...
      opportunity: {
        ...
        endDate: daysAhead(4),
        genres: ["Indie"],
        deal: { $type: "versus", paymentMethod: "Transfer", guarantee: 320, artistDoorPercent: 50 },
      },
      actions: {},
    },
  ],
  ...
  recommendedOpportunities: [
    {
      ...
      genres: ["Indie"],
      deal: { $type: "versus", paymentMethod: "Transfer", guarantee: 280, artistDoorPercent: 60 },
      fitScore: 87,
    ...
    },
    {
      ...
      genres: ["Indie", "Rock"],
      deal: { $type: "versus", paymentMethod: "Transfer", guarantee: 200, artistDoorPercent: 70 },
      fitScore: 81,
