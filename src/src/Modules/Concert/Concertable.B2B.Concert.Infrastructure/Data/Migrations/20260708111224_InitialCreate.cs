        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArtistConsent_UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ArtistConsent_AtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ArtistConsent_Ip = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ArtistConsent_UserAgent = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TermsFingerprint = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArtistConsent_Ip = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ArtistConsent_UserAgent = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VenueConsent_UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    VenueConsent_AtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    VenueConsent_Ip = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VenueConsent_UserAgent = table.Column<string>(type: "nvarchar(max)", nullable: true),
