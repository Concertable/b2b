...
public sealed class AdminProvisioningTests : IAsyncLifetime
{
    ...
    public async Task Login_InvitedEmail_MatchesCaseInsensitively()
    {
        ...
        await RegisterAsync(new CredentialRegisteredEvent(newUserId, rawEmail, InteractiveClientInfo.Get(InteractiveClient.Admin).Id));
    ...
    public async Task Login_BootstrapEmail_GrantsNoAdminProfile_WhenAnAdminAlreadyExists()
    {
        ...
        await RegisterAsync(new CredentialRegisteredEvent(existingAdminUserId, existingAdminEmail, InteractiveClientInfo.Get(InteractiveClient.Admin).Id));
