        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArtistESignature_UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ArtistESignature_AtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ArtistESignature_Ip = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ArtistESignature_UserAgent = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ArtistESignature_SignatoryName = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VenueESignature_Ip = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VenueESignature_UserAgent = table.Column<string>(type: "nvarchar(max)", nullable: true),
