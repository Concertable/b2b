...
/// <summary>
/// Resolves the tenant a concert's settlement <em>pays</em> — the DAC7 "seller" who receives the money. This is
...
/// inverse — so the DAC7 gate reads the settlement recipient directly rather than inverting an unrelated concept.
