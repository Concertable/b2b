...
public sealed class ApplicationVersusApiTests : IAsyncLifetime
{
    ...
    public ApplicationVersusApiTests(ConcertApiFixture fixture, ITestOutputHelper output)
    {
    ...
    public async Task Apply_ShouldCreateStandardApplication_WithoutPaymentMethod()
    {
        ...
        var oppResponse = await venueClient.PostAsync("/api/opportunity",
            BuildRequest(new VersusDealDto { PaymentMethod = PaymentMethod.Cash, Guarantee = 200, ArtistDoorPercent = 60 }, fixture.SeedNow));
    ...
    public async Task Accept_ShouldNotCreateDraft_WhenVerifyPaymentFails()
    {
        ...
        // Assert
        var application = await fixture.ConcertReads.Set<ApplicationEntity>().FirstAsync(a => a.Id == fixture.SeedState.VersusApp.Id);
