...
services.AddOpportunityModule(builder.Configuration);
services.AddApplicationModule(builder.Configuration);
services.AddBookingModule(builder.Configuration);
services.AddOpportunityApi();
services.AddApplicationApi();
services.AddBookingApi();
